...
// // send it to the state class to let it deal with it within its
// functions(print
// // for ex)
...
// // print to user
// System.out.println("Use 'w' for UP, 'a' for LEFT, 's' for DOWN, 'd' for
...
// return;
// default:
// System.out.println("Invalid input. Use 'w', 'a', 's', 'd' to move, or 'q' to
// quit.");
// continue;
// }
