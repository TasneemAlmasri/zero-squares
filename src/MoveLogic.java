...
// // access the board (which is a copy of the original),the copy itself,not a
// copy
// // of the copy
// return state.board;
// }

// // function takes in coordinates and direction then returns Point that
// represent
// // closest wall in that direction
...
// // takes in a color square and the closest wall to it then returns the count
// of
// // color squares between them
...
// String[][] board = board();
// for (int i = start + 1; i < end; i++) {
// // two lines to know if im looping in rows or cols(i have start and end,but
// dont
// // know in board[][] who is i and who is constant)
// int rindex = r1 != r2 ? i : r1;
// int cindex = c1 != c2 ? i : c1;
...
// // check if my goal exists in the area between me and the wall(dont want it
// if
// // its after the wall)
...
// int rindex = r1 != r2 ? i : r1;
// int cindex = c1 != c2 ? i : c1;
// if (board[rindex][cindex].charAt(0) == 'G' && board[rindex][cindex].charAt(1)
// == color.charAt(0)) {
// return new Point(rindex, cindex);
// }
// }
...
// switch (direction) {
// case 'l':
// return c - 1 >= 0 && (board[r][c - 1].equals(" ") || board[r][c -
// 1].charAt(0) == 'G'
// || board[r][c - 1].equals("B"));// here new
// case 'r':
// return c + 1 < board[r].length && (board[r][c + 1].equals(" ") || board[r][c
// + 1].charAt(0) == 'G'
// || board[r][c + 1].equals("B"));
// case 'u':
// return r - 1 >= 0 && (board[r - 1][c].equals(" ") || board[r -
// 1][c].charAt(0) == 'G'
// || board[r - 1][c].equals("B"));
// case 'd':
// return r + 1 < board.length && (board[r + 1][c].equals(" ") || board[r +
// 1][c].charAt(0) == 'G'
// || board[r + 1][c].equals("B"));
// default:
// return false;
...
// //
// .......................................................................................................
// // move one color,these functions wont be called unless the square CAN (not
// near
// // wall or another color) move in the needed direction
// List<Point> removedGoals = new ArrayList<>();
...
// initBoards[level]
// // System.out.println("I AM IN THE WASGOAL ");
// // if in the original its goal,note that it wont be its own goal,cause it
// wont
